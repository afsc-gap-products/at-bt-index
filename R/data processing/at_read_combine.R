...
#' unique interval (across all layers and classes which is key3) and the ground 
#' depth, which is the smallest of the lower bin
...
# Below 3m data (from a different source) -------------------------------------
...
# For 2022 and 2024, you need an additional, later column to calculate area
