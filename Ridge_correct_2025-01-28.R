...
setwd( R'(C:\Users\James.Thorson\Desktop\Work files\AFSC\2025-01 -- ridge.correct for acoustics and bottom trawl)' )
...
extrap = cbind( 'Lon'=extrap[,1], 'Lat'=extrap[,2], 'Area_in_survey_km2'=st_area(grid) / 1e6 )
